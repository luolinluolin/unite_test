...
#define _DFT_IDFT_3        (3)
#define _DFT_IDFT_6        (6)
#define _DFT_IDFT_1440     (1440)
#define _DFT_IDFT_1296     (1296)
#define _DFT_IDFT_1500     (1500)
#define _DFT_IDFT_1620     (1620)
#define _DFT_IDFT_1728     (1728)
#define _DFT_IDFT_1920     (1920)
#define _DFT_IDFT_1944     (1944)
#define _DFT_IDFT_2160     (2160)
#define _DFT_IDFT_2304     (2304)
#define _DFT_IDFT_2400     (2400)
#define _DFT_IDFT_2592     (2592)
#define _DFT_IDFT_2700     (2700)
#define _DFT_IDFT_2880     (2880)
#define _DFT_IDFT_2916     (2916)
#define _DFT_IDFT_3000     (3000)
#define _DFT_IDFT_3072     (3072)
#define _DFT_IDFT_3240     (3240)
#define _DFT_IDFT_1536     (1536)
#define _DFT_IDFT_1632     (1632)
#define _DFT_IDFT_1728     (1728)
#define _DFT_IDFT_1200     (1200)
#define _DFT_IDFT_1152     (1152)
#define _DFT_IDFT_1080     (1080)
#define _DFT_IDFT_972      (972)
#define _DFT_IDFT_960      (960)
#define _DFT_IDFT_900      (900)
#define _DFT_IDFT_864      (864)
#define _DFT_IDFT_816      (816)
#define _DFT_IDFT_768      (768)
#define _DFT_IDFT_720      (720)
#define _DFT_IDFT_648      (648)
#define _DFT_IDFT_600      (600)
#define _DFT_IDFT_576      (576)
#define _DFT_IDFT_540      (540)
#define _DFT_IDFT_480      (480)
#define _DFT_IDFT_432      (432)
#define _DFT_IDFT_384      (384)
#define _DFT_IDFT_360      (360)
#define _DFT_IDFT_324      (324)
#define _DFT_IDFT_300      (300)
#define _DFT_IDFT_288      (288)
#define _DFT_IDFT_240      (240)
#define _DFT_IDFT_216      (216)
#define _DFT_IDFT_192      (192)
#define _DFT_IDFT_180      (180)
#define _DFT_IDFT_168      (168)
#define _DFT_IDFT_144      (144)
#define _DFT_IDFT_120      (120)
#define _DFT_IDFT_108      (108)
#define _DFT_IDFT_96       (96)
#define _DFT_IDFT_72       (72)
#define _DFT_IDFT_64       (64)
#define _DFT_IDFT_60       (60)
#define _DFT_IDFT_48       (48)
#define _DFT_IDFT_36       (36)
#define _DFT_IDFT_24       (24)
#define _DFT_IDFT_16       (16)
#define _DFT_IDFT_12       (12)
#define _DFT_IDFT_4        (4)
...
template<int NUM_BYTES = 0> // If no specified NUM_BYTES, then need to pass nBytes for other store.
inline
void storeBytes(int8_t* ptr, __m512i values, int32_t nBytes = 0) {
    static_assert(NUM_BYTES <= 64);

    if constexpr (NUM_BYTES == 8)
        _mm_mask_storeu_epi8(ptr, 0x00ff, _mm512_castsi512_si128(values));
    if constexpr (NUM_BYTES == 16)
        _mm_storeu_epi8(ptr, _mm512_castsi512_si128(values)); 
    else if constexpr (NUM_BYTES == 32)
        _mm256_storeu_epi8(ptr, _mm512_castsi512_si256(values));
    else if constexpr (NUM_BYTES == 64)
        _mm512_storeu_epi8(ptr, values);
    else
    {
        int64_t mask = ((uint64_t) 1 << nBytes) - 1;
...
void llr_store<BBLIB_QAM256, 2>(int8_t * ppSoft, __m512i* xRe, __m512i* xIm)
{
    ...
    storeBytes<64>(ppSoft+128,avxtempDRe);

    auto avxtempDIm= _mm512_permutex2var_epi16(xRe[1], qam256_second_64, xIm[1]);
    storeBytes<64>(ppSoft+192,avxtempDIm);
}
...
void llr_store<BBLIB_QPSK, 1>(int8_t * ppSoft, __m512i*  xRe, __m512i*  xIm, int32_t nSc)
{
    xRe[0] = _mm512_packs_epi16(xRe[0], xRe[0]);
    xRe[0] = _mm512_permutexvar_epi64(qpsk_perm_idx,xRe[0]);
    storeBytes(ppSoft, xRe[0], (nSc * BBLIB_QPSK));
}
...
{
    xRe[0] = _mm512_shuffle_epi8(xRe[0], qam16_shuffle_idx);
    storeBytes(ppSoft, xRe[0], (nSc * BBLIB_QAM16));
}
...
{
    if (nSc == 2 || nSc == 4 || nSc == 6 || nSc == 8 || nSc == 10)
    {
        auto avxtempCRe = _mm512_permutex2var_epi16(xRe[0], qam64_first_64, xIm[0]);
        storeBytes(ppSoft, avxtempCRe, (nSc * BBLIB_QAM64));
    }
    else if (nSc == 12) {
        auto avxtempCRe = _mm512_permutex2var_epi16(xRe[0], qam64_first_64, xIm[0]);
        storeBytes<64>(ppSoft,avxtempCRe);
        ...
        auto avxtempCIm= _mm512_permutex2var_epi16(xRe[0], qam64_second_32, xIm[0]);
        storeBytes(ppSoft + 64, avxtempCIm, (nSc * BBLIB_QAM64 - 64));
    }
}
...
void llr_store<BBLIB_QAM256, 1>(int8_t * ppSoft, __m512i*  xRe, __m512i*  xIm, int32_t nSc)
{
    ...
    else if(nSc == 2 || nSc == 4 || nSc == 6){
        //rest 32
        storeBytes(ppSoft, avxtemp1, (nSc * BBLIB_QAM256));
    } else {
        storeBytes<64>(ppSoft,avxtemp1);
        auto avxtemp2= _mm512_permutex2var_epi16(xRe[0], qam256_second_64, xIm[0]);
        if(nSc == 10){
            storeBytes<16>(ppSoft + 64, avxtemp2);
        }
        else if(nSc == 12){
            storeBytes<32>(ppSoft + 64, avxtemp2);
        }
    }
}
...
void llr_store<BBLIB_QPSK, 2>(int8_t * ppSoft, __m512i*  xRe, __m512i*  xIm, int32_t nSc)
{
    ...
    storeBytes(ppSoft, xRe[0], (nSc * BBLIB_QPSK * 2));
}
...
void llr_store<BBLIB_QAM16, 2>(int8_t * ppSoft, __m512i*  xRe, __m512i*  xIm, int32_t nSc)
{
    ...
    if (nSc == 2 || nSc == 4 || nSc == 6) {
        //rest 32
        storeBytes(ppSoft, xRe[0], (nSc * BBLIB_QAM16 * 2));
    }
    else if (nSc == 10 || nSc == 12) {
        storeBytes<64>(ppSoft,xRe[0]);
        xRe[1] = _mm512_shuffle_epi8(xRe[1], qam16_shuffle_idx);

        storeBytes(ppSoft + 64, xRe[1], ((nSc - 8) * BBLIB_QAM16 * 2));
    }
    else{
        storeBytes<64>(ppSoft,xRe[0]);
    }
...
void llr_store<BBLIB_QAM64, 2>(int8_t * ppSoft, __m512i*  xRe, __m512i*  xIm, int32_t nSc)
{
    ...
    if (nSc == 2 || nSc == 4) {
        //rest 32
        storeBytes(ppSoft, avxtempCRe, (BBLIB_QAM64 * 2 * nSc));
    } else {
        storeBytes<64>(ppSoft,avxtempCRe);
        ...
        if (nSc == 6) {
            //rest 8
            storeBytes<8>(ppSoft + 64, avxtempCIm);
        } else if (nSc == 8) {
            //rest 32
            storeBytes<32>(ppSoft + 64, avxtempCIm);
        } else if (nSc == 10) {
            //rest 56
            storeBytes(ppSoft + 64, avxtempCIm, 56);
        } else if (nSc == 12) {
            //second 64
            storeBytes<64>(ppSoft + 64,avxtempCIm);
            //rest 16
            storeBytes<16>(ppSoft + 128, avxtempDIm);
        }
    }
}
...
void llr_store<BBLIB_QAM256, 2>(int8_t * ppSoft, __m512i* xRe, __m512i* xIm, int32_t nSc)
{
    auto avxtempCRe = _mm512_permutex2var_epi16(xRe[0], qam256_first_64, xIm[0]);
    if (nSc == 2) {
        storeBytes<32>(ppSoft, avxtempCRe);
    } else {
        storeBytes<64>(ppSoft,avxtempCRe); // nSc == 4, 6, 8, 10, 12

        if (nSc != 4) {
            auto avxtempCIm= _mm512_permutex2var_epi16(xRe[0], qam256_second_64, xIm[0]);
            if (nSc == 6) {
                storeBytes<32>(ppSoft+64, avxtempCIm); // nSc == 6
            } else {
                storeBytes<64>(ppSoft+64,avxtempCIm); // nSc == 8, 10, 12

                if (nSc == 10) {
                    auto avxtempDRe = _mm512_permutex2var_epi16(xRe[1], qam256_first_64, xIm[1]);
                    storeBytes<32>(ppSoft+128, avxtempDRe); // nSc == 10
                } else if (nSc == 12) {
                    auto avxtempDRe = _mm512_permutex2var_epi16(xRe[1], qam256_first_64, xIm[1]);
                    storeBytes<64>(ppSoft+128,avxtempDRe); // nSc == 12
                }
            }
        }
    }
...
struct DEMAPPER {
    ...
    FORCE_INLINE inline
    static void permutexvar_DmrsData(size_t nLayerIdx,uint16_t portId, uint8_t nSc48Idx,FloatSimd *pPostSINR, FloatSimd *pGain, Is16vec32 *pTx,FloatSimd *pTempPostSINR, FloatSimd *pTempGain) {
        if constexpr (1 == DMRSTYPE) {
            pTempPostSINR[nLayerIdx] = _mm512_permutexvar_ps(data_dmrs_type1[portId], pPostSINR[nLayerIdx]);
            pTempGain[nLayerIdx]     = _mm512_permutexvar_ps(data_dmrs_type1[portId], pGain[nLayerIdx]);
            pTx[nLayerIdx]       = _mm512_permutexvar_epi32(data_dmrs_type1[portId], pTx[nLayerIdx]);
        } else {//type2
            if constexpr (1 == NROFCDMS) {
                pTempPostSINR[nLayerIdx] = _mm512_permutexvar_ps(data_dmrs_type2_cdms1_idx[nSc48Idx], pPostSINR[nLayerIdx]);
                pTempGain[nLayerIdx]     = _mm512_permutexvar_ps(data_dmrs_type2_cdms1_idx[nSc48Idx], pGain[nLayerIdx]);
                pTx[nLayerIdx]       = _mm512_permutexvar_epi32(data_dmrs_type2_cdms1_idx[nSc48Idx], pTx[nLayerIdx]);
            }
            else{
                pTempPostSINR[nLayerIdx] = _mm512_permutexvar_ps(data_dmrs_type2_cdms2_idx[nSc48Idx], pPostSINR[nLayerIdx]);
                pTempGain[nLayerIdx]     = _mm512_permutexvar_ps(data_dmrs_type2_cdms2_idx[nSc48Idx], pGain[nLayerIdx]);
                pTx[nLayerIdx]       = _mm512_permutexvar_epi32(data_dmrs_type2_cdms2_idx[nSc48Idx], pTx[nLayerIdx]);
            }
        }
    }

    static int32_t data_dmrs_mux_nSc_calc (const int32_t nSc, const uint8_t nSc48Idx) {
        int8_t nDataNum = 0;
    ...
    FORCE_INLINE inline
    static void demaper(const int8_t nMu, const uint16_t *pLayerNum, uint16_t userLayer, const enum bblib_modulation_order eModOrder[BBLIB_MAX_MU],
        int8_t *pLlr[BBLIB_MAX_MU], FloatSimd *ftempPostSINR, FloatSimd  *ftempGain, Is16vec32 *avxxTxSymbol, const int32_t nSc, const int32_t nSCIdx, 
        const int16_t llr_range_low, const int16_t llr_range_high, const uint16_t nDmrsPortIdx = 0) {

        uint8_t nSc48Idx = 0;
        if constexpr (data_dmrs_mux_flag == DATA_DMRS_MUX_E::enable && DMRSTYPE == 2) {
            nSc48Idx = (nSCIdx >> 4) % 3;
        }
        FloatSimd ftempGaintmp[N_TX_8];
        FloatSimd ftempPostSINRtmp[N_TX_8];

        int32_t nDataNum = nSc;
        for(int8_t imu = nMu - 1; imu >= 0; imu--) {
            ...
            if constexpr (data_dmrs_mux_flag == DATA_DMRS_MUX_E::enable) {
                pPostSINR = &ftempPostSINRtmp[userLayer];
                pGain = &ftempGaintmp[userLayer];
                auto portId = (nDmrsPortIdx == 0) + (nDmrsPortIdx == 1);
                for (size_t iLayer = 0; iLayer < nLayerPerUe; iLayer++) {
                    permutexvar_DmrsData(iLayer,portId,nSc48Idx,&ftempPostSINR[userLayer],&ftempGain[userLayer],pTx,pPostSINR,pGain);
                }
                nDataNum = data_dmrs_mux_nSc_calc(nSc, nSc48Idx);
            }

            if (nLayerPerUe == 1) {
                demaper_llr<1>(modOrder, pPostSINR, pGain, pTx, pLlr[imu], llr_range_low, llr_range_high, nDataNum);
            } else if (nLayerPerUe == 2) {
                demaper_llr<2>(modOrder, pPostSINR, pGain, pTx, pLlr[imu], llr_range_low, llr_range_high, nDataNum);
            }
            pLlr[imu] += nDataNum * nLayerPerUe * modOrder;
        }
    }
};
